...
class CenterDistLossPluginMetric(GenericPluginMetric[float]):
    def __init__(self, reset_at, emit_at, mode):
        self._loss = Loss()
        super(CenterDistLossPluginMetric, self).__init__(
    ...
    def update(self, strategy):
        if(strategy.plugins[0].prev_model_frozen != None):
            ...
            self._loss.update(strategy.plugins[0].centerDistLoss,
                            patterns=len(strategy.mb_y), task_label=task_label)

class MinibatchCenterDistLoss(CenterDistLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        """
        super(MinibatchCenterDistLoss, self).__init__(
            reset_at='iteration', emit_at='iteration', mode='train')

    def __str__(self):
        return "CenterDistLoss_MB"

class EpochCenterDistLoss(CenterDistLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        super(EpochCenterDistLoss, self).__init__(
            reset_at='epoch', emit_at='epoch', mode='train')

    def __str__(self):
        return "CenterDist_Loss_Epoch"