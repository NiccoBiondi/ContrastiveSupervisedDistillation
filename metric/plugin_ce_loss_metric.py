...
class CELossPluginMetric(GenericPluginMetric[float]):
    def __init__(self, reset_at, emit_at, mode):
        self._loss = Loss()
        super(CELossPluginMetric, self).__init__(
    ...
    def update(self, strategy):
        ...
        self._loss.update(strategy.plugins[0].ceLoss,
                          patterns=len(strategy.mb_y), task_label=task_label)

class MinibatchCELoss(CELossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        """
        super(MinibatchCELoss, self).__init__(
            reset_at='iteration', emit_at='iteration', mode='train')

    def __str__(self):
        return "CELoss_MB"

class EpochCELoss(CELossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        super(EpochCELoss, self).__init__(
            reset_at='epoch', emit_at='epoch', mode='train')

    def __str__(self):
        return "CE_Loss_Epoch"