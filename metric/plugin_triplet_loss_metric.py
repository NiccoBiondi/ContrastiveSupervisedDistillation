...
class TripletLossPluginMetric(GenericPluginMetric[float]):
    def __init__(self, reset_at, emit_at, mode):
        self._loss = Loss()
        super(TripletLossPluginMetric, self).__init__(
    ...
    def update(self, strategy):
        ...
        self._loss.update(strategy.plugins[0].tripletLoss,
                          patterns=len(strategy.mb_y), task_label=task_label)

class MinibatchTripletLoss(TripletLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        """
        super(MinibatchTripletLoss, self).__init__(
            reset_at='iteration', emit_at='iteration', mode='train')

    def __str__(self):
        return "TripletLoss_MB"

class EpochTripletLoss(TripletLossPluginMetric):
    """
    ...
    def __init__(self):
        ...
        super(EpochTripletLoss, self).__init__(
            reset_at='epoch', emit_at='epoch', mode='train')

    def __str__(self):
        return "Triplet_Loss_Epoch"